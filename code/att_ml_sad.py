...
class Attention:
    def __init__(self, model, training_src, training_tgt, lang_li):
        ...
        self.w2_att = {}
        for ele in lang_li:
            self.W1_att_e[ele] = self.model.add_parameters((self.attention_size, 2 * self.hidden_size))
            self.W1_att_f[ele] = self.model.add_parameters((self.attention_size, 2 * self.hidden_size))
            self.w2_att[ele] = self.model.add_parameters((1, self.attention_size))
    ...
    def step_batch(self, batch, lang):
        ...
        W1_att_e = dy.parameter(self.W1_att_e[lang])
        W1_att_f = dy.parameter(self.W1_att_f[lang])
        w2_att = dy.parameter(self.w2_att[lang])
